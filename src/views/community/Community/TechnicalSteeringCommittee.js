    ...
    <Card className={classes.root, classes.linkCard} elevation={0}>
      <CardContent>
        <Typography className={classes.title}>
          ...
          Monthly Technical Steering Committee Meeting<br/>
        </Typography>
        <Typography >
...
charter falls into 2 categories:
          ...
          <Button
            ...
            type="submit"
            variant="contained"
          >See this Google Doc</Button><br/>
for the Meeting notes and agenda for all past and the upcomming meetings.<br/><br/>
          
Meetings are held the 3rd Thursday of the month at 10:00 am Washington, DC time [EST]<br/>
Also see the Gitter for this groups discussions.<br/>
          <Button
            color="primary"
            size="large"
            type="submit"
          ...
          >Join here</Button>
          <div>
            Meeting number: 120 613 0391<br/>

            Join by phone<br/>
            +1-415-655-0003 US TOLL<br/>

            +1-855-282-6330 US TOLL FREE<br/>

            Access code: 120 613 0391<br/>
          </div>
